...
load_dotenv(env_file_path if os.path.exists(env_file_path) else find_dotenv())
...
if EMBEDDINGS_PROVIDER in (EmbeddingsProvider.OPENAI, EmbeddingsProvider.AZURE, EmbeddingsProvider.GOOGLE_GENAI):
